...
export default function PresidentCard({
  ...
  if (!roleConfig) {
    console.warn(
      `No configuration found for role: ${role} in division: ${division}`
    );
    return null;
  }
  ...
  return (
    <div
      id={id}
      className="committee-card relative w-46 h-63 sm:w-46 bg-white shadow-md rounded-md text-center pt-4"
    >
