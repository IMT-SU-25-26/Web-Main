...
const AchievementFeatured: FC<AchievementFeaturedProps> = ({
    ...
    return (
        ...
        <div
            className="relative flex flex-col md:flex-row gap-4 px-6 py-6 bg-cover bg-no-repeat bg-center max-w-5xl mx-auto"
            style={{
        ...
        >
            {/* Image */}
            <div className="relative w-[160px] h-[120px] bg-gray-300 flex-shrink-0">
            <Image
                src={imageUrl}
                alt={title}
                fill
