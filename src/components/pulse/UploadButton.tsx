    ...
    >
      {({ open }) => (
        <button
          type="button"
          onClick={() => open()}
          className={`w-full flex items-center justify-center gap-3 p-2 sm:p-3 rounded-md border-2 transition-all ${
            hasFile
        ...
        >
          ...
          <span className="font-family-poppins text-sm sm:text-base">
