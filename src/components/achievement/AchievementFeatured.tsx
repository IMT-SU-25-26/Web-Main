...
const AchievementFeatured: FC<AchievementFeaturedProps> = ({
    ...
    return (
        <div className="w-full overflow-visible">
            <div
                className="relative -left-5 md:left-0 bg-cover bg-no-repeat bg-left-bottom min-h-[400px] md:min-h-[200px] py-6"
                style={{
                backgroundImage: "url('/achievements/AchievementFeaturedBG.svg')",
                }}
            >
                <div className="my-2 max-w-5xl mx-auto px-4 ml-[50px] md:px-6 lg:px-8 flex flex-col md:flex-row gap-4">
                    {/* Image */}
