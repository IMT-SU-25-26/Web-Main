...
const CompetitionsBackground = () => {
    ...
    return (
        <div  ref={bgRef}>
            ...
            <div className="start-bottom relative inline-block z-10">
                {/* Pin */}
                <Image
            ...
            alt="Light Bulb"
            className="decor-img absolute select-none top-26 left-[0.3] w-28 md:left-6 md:w-30 z-10"
            width={500}
            height={500}
            draggable={false}
            />
...
export default CompetitionsBackground