...
export default function ClientHomePage({ latestActivities }: ClientHomePageProps) {
                ...
                >
                  <div className="mobile-competition-content z-[25] relative w-full h-full flex flex-col justify-center items-center p-4">
                    ...
                    <Image
                      ...
                      alt="star-card"
                    />
                    <div className="image-mobile-container w-full h-[5.5rem] bg-[url('/home/comp.jpg')] bg-cover bg-no-repeat"></div>
            ...
            {latestActivities.length > 0 && (
              <>
                <HomeServicesCard
                  ...
                  description={truncateDescription(latestActivities[1]?.description || "No description available")}
                  imageUrl={latestActivities[1]?.imageUrl || undefined}
                  color="#0555AB"
                  opacity="75%"
                />
                <HomeServicesCard
                  ...
                  description={truncateDescription(latestActivities[0]?.description || "No description available")}
                  imageUrl={latestActivities[0]?.imageUrl || undefined}
                  color="#0555AB"
                  opacity="100%"
                />
                <HomeServicesCard
                  ...
                  description={truncateDescription(latestActivities[2]?.description || "No description available")}
                  imageUrl={latestActivities[2]?.imageUrl || undefined}
                  color="#0555AB"
                  opacity="75%"
                />
              </>
