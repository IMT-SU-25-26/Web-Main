...
// Component to render files (images or PDFs)
function FileViewer({
  url,
  alt,
  label,
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col items-start lg:items-end gap-3">
              <div className="bg-blue-50 border border-blue-200 rounded-lg px-4 py-2">
                ...
                <div className="text-lg font-semibold text-blue-900">{application.major}</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="px-8 py-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="mt-1 text-lg font-semibold text-gray-900">{application.name}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Student ID (NIM)</label>
                    <div className="mt-1 text-lg font-mono font-semibold text-gray-900 bg-gray-100 px-3 py-1 rounded-md inline-block">
                      {application.nim}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Email Address</label>
                    <div className="mt-1 text-lg text-gray-900">{application.email}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Major</label>
                    <div className="mt-1 text-lg text-gray-900">{application.major}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Phone Number</label>
                    <div className="mt-1 text-lg text-gray-900">{application.phoneNumber}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Line ID</label>
                    <div className="mt-1 text-lg text-gray-900">{application.lineId}</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="px-8 py-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="text-center">
                    <div className="text-sm font-medium text-gray-500 mb-2">First Choice</div>
                  ...
                  <div className="text-center">
                    <div className="text-sm font-medium text-gray-500 mb-2">Second Choice</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="text-sm font-medium text-blue-600">Application Status</div>
                  <div className="text-lg font-bold text-blue-900 mt-1">Under Review</div>
                </div>
