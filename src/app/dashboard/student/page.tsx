...
export default async function StudentDashboard() {
  ...
  const [applications, userInfo] = await Promise.all([
    getApplicationsByUserId(session.user.id),
                ...
                <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                  ...
                  <div className="text-center sm:text-left">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-family-impact text-[#0555AB] mb-1">
                      Welcome back, {userInfo?.name?.split(" ")[0] || "Student"}
                      ! 👋
                    </h1>
            ...
            {applications.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 mb-8 text-lg font-family-gill max-w-md mx-auto">
                  You haven&apos;t applied for any activities yet. Start
                    ...
                    <tbody className="bg-white">
                      {applications.map((app, idx) => {
                        ...
                        return (
                          <tr
                            key={app.id}
                            className={`border-b-2 border-[#0555AB]/20 hover:bg-[#F8A5C2]/10 transition-colors duration-200 ${
                              isEven ? "bg-white" : "bg-[#F8A5C2]/20"
                            }`}
                          >
